...
namespace AONLOGBOOK.API.Controllers
{
	...
	public class FunctionalLocationMastersController : ControllerBase
	{
		...
		[HttpGet("GetList")]
		public async Task<ActionResult<IEnumerable<TblFunctionalLocationMaster>>> GetTblFunctionalLocationList()
		{
			return await _context.TblFunctionalLocationMasters.ToListAsync();
		}
